---
name: draw-diagrams
description: Turn the maps and traced flows of a codebase into mermaid diagrams that render in markdown: component and architecture diagrams, one sequence diagram per traced flow, a module dependency graph, and an ER diagram from the data model. Produces docs/codebase-map/diagrams.md and reusable blocks for the other docs. Use when the user asks for diagrams, a visual, a flowchart, a sequence diagram, an ER diagram, or "draw the architecture". Builds on explore-codebase.
---
...
Per-diagram mermaid templates: [references/mermaid-recipes.md](references/mermaid-recipes.md).
