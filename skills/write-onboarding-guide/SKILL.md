...
description: Write the getting-started guide for a new engineer on a codebase: what the system does, how to install and run and test it locally, the entry points, the five files to read first, and a glossary of domain terms. Produces docs/codebase-map/onboarding.md. Use when the user asks for an onboarding guide, a getting-started doc, a new-developer tour, or "how would someone new get up to speed on this". Builds on explore-codebase.
---
